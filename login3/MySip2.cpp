...
void MySip2::add_friends(list<Friend_inf> *lis)
{
...
void MySip2::delete_friends(CString *id)
{
...
bool MySip2::state_friends(CString fr_id)
{
...
void MySip2::on_incoming_call(pjsua_acc_id acc_id, pjsua_call_id call_id,
	pjsip_rx_data *rdata)
{
	pThis1->rec_flag = 1;
	pjsua_call_info ci;
...
void MySip2::on_call_state(pjsua_call_id call_id, pjsip_event *e)
{
	pjsua_call_info ci;
...
void MySip2::on_call_media_state(pjsua_call_id call_id)
{
	pjsua_call_info ci;
...
void MySip2::error_exit(const char *title, pj_status_t status)
{
	string s = title;
...
void MySip2::make_call(pj_str_t uri)
{
	pjsua_call_setting call_setting;
	pjsua_call_setting_default(&call_setting);
	call_setting.vid_cnt = 1;
